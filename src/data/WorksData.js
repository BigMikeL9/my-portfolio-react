...
const worksData = [
  {
    ...
    overview:
      "A website developed for the National Library of Medicine as part of their Exhibition program.",
    details: {
